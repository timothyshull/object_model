...
function __ZNK1Y2m1Ev() {
    rax = std::__1::basic_ostream<char, std::__1::char_traits<char> >& std::__1::operator<< <std::__1::char_traits<char> >(std::__1::cout, "Y::m1()\n");
    return rax;
}
...
function __ZNK1Z2m1Ev() {
    rax = std::__1::basic_ostream<char, std::__1::char_traits<char> >& std::__1::operator<< <std::__1::char_traits<char> >(std::__1::cout, "Z::m1()\n");
    return rax;
}
...
function sub_100001e50() {
    rsp = rsp - 0x8;
    dyld_stub_binder();
    return;
}

function sub_100001ea0() {
    loc_100001e04();
    return;
}
