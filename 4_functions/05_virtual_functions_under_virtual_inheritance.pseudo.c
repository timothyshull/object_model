...
function __ZN2AAC1Ev() {
    ...
    Z::Z();
    *rdi = 0x100002118;
    *(rdi + 0x20) = 0x100002170;
    *(rdi + 0x8) = 0x100002138;
    *(rdi + 0x10) = 0x100002150;
    return 0x100002118;
}

function __ZN2AA1mEv() {
    *(int32_t *)(rdi + *(*rdi + 0xffffffffffffffe8) + 0x8) = 0x5;
    *(int32_t *)(rdi + *(*(rdi + 0x8) + 0xffffffffffffffe8) + 0x10) = 0x6;
    *(int32_t *)(rdi + 0x18) = 0x7;
    rax = std::__1::basic_ostream<char, std::__1::char_traits<char> >::operator<<(std::__1::cout, *(int32_t *)(rdi + *(*rdi + 0xffffffffffffffe8) + 0x8));
    rax = std::__1::basic_ostream<char, std::__1::char_traits<char> >::operator<<(rax, *(int32_t *)(rdi + *(*(rdi + 0x8) + 0xffffffffffffffe8) + 0x10));
    rax = std::__1::basic_ostream<char, std::__1::char_traits<char> >::operator<<(rax, *(int32_t *)(rdi + 0x18));
    rax = std::__1::basic_ostream<char, std::__1::char_traits<char> >& std::__1::operator<< <std::__1::char_traits<char> >(rax, 0xa);
    return rax;
}
...
function __ZN1X1mEv() {
    *(int32_t *)(rdi + *(*rdi + 0xffffffffffffffe8) + 0x8) = 0x2;
    rax = std::__1::basic_ostream<char, std::__1::char_traits<char> >& std::__1::operator<< <std::__1::char_traits<char> >(std::__1::cout, "X::m() -> B::n = ");
    rax = std::__1::basic_ostream<char, std::__1::char_traits<char> >::operator<<(rax, *(int32_t *)(rdi + *(*rdi + 0xffffffffffffffe8) + 0x8));
...
function __ZN1Y1mEv() {
    *(int32_t *)(rdi + *(*rdi + 0xffffffffffffffe8) + 0x8) = 0x3;
    rax = std::__1::basic_ostream<char, std::__1::char_traits<char> >& std::__1::operator<< <std::__1::char_traits<char> >(std::__1::cout, "Y::m() -> B::n = ");
    rax = std::__1::basic_ostream<char, std::__1::char_traits<char> >::operator<<(rax, *(int32_t *)(rdi + *(*rdi + 0xffffffffffffffe8) + 0x8));
    rax = std::__1::basic_ostream<char, std::__1::char_traits<char> >& std::__1::operator<< <std::__1::char_traits<char> >(rax, "\n");
    return rax;
}
...
function __ZN1B1mEv() {
    *(int32_t *)(rdi + 0x8) = 0x1;
    rax = std::__1::basic_ostream<char, std::__1::char_traits<char> >& std::__1::operator<< <std::__1::char_traits<char> >(std::__1::cout, "B::m() -> n = ");
    rax = std::__1::basic_ostream<char, std::__1::char_traits<char> >::operator<<(rax, *(int32_t *)(rdi + 0x8));
    rax = std::__1::basic_ostream<char, std::__1::char_traits<char> >& std::__1::operator<< <std::__1::char_traits<char> >(rax, "\n");
    return rax;
}
...
function __ZN1Z1mEv() {
    *(int32_t *)(rdi + 0x8) = 0x4;
    rax = std::__1::basic_ostream<char, std::__1::char_traits<char> >& std::__1::operator<< <std::__1::char_traits<char> >(std::__1::cout, "Z::m() -> B::n = ");
    rax = std::__1::basic_ostream<char, std::__1::char_traits<char> >::operator<<(rax, *(int32_t *)(rdi + 0x8));
    rax = std::__1::basic_ostream<char, std::__1::char_traits<char> >& std::__1::operator<< <std::__1::char_traits<char> >(rax, "\n");
    return rax;
}
