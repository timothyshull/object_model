int _main() {
    if (0xffffffffffffffff == 0x8) {
            std::__1::basic_ostream<char, std::__1::char_traits<char> >& std::__1::operator<< <std::__1::char_traits<char> >(std::__1::cout, "p1 & p2 address the same member\n");
    }
    memset(&var_20, 0x0, 0x8);
    func2(&var_20);
    return 0x0;
}
