...
function __Z5func2b() {
    var_24 = func1(arg0 & 0x1 & 0xff & 0x1);
    var_30 = std::__1::basic_ostream<char, std::__1::char_traits<char> >::operator<<(std::__1::cout, var_24);
    rax = std::__1::basic_ostream<char, std::__1::char_traits<char> >& std::__1::operator<< <std::__1::char_traits<char> >(var_30, "\n");
    return rax;
}
