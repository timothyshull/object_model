int _main() {
    xmm0 = intrinsic_movsd(xmm0, *0x100001ec0);
    var_10 = *(int8_t *)0x100001ec9;
    intrinsic_movsd(var_18, xmm0);
    void B::operator();
    void B::operator(&var_10, &var_1C);
    std::__1::basic_ostream<char, std::__1::char_traits<char> >& std::__1::operator<< <std::__1::char_traits<char> >(std::__1::basic_ostream<char, std::__1::char_traits<char> >::operator<<(std::__1::cout, 0x0), 0xa);
    std::__1::basic_ostream<char, std::__1::char_traits<char> >& std::__1::operator<< <std::__1::char_traits<char> >(std::__1::basic_ostream<char, std::__1::char_traits<char> >::operator<<(std::__1::cout, 0x1), 0xa);
    return 0x0;
}

function __ZN1AIiE1mEv() {
    return rax;
}

function __ZN1AIdE1mEv() {
    return rax;
}

function __Z1fIdEvT_() {
    intrinsic_movsd(xmm0, intrinsic_movsd(var_8, xmm0));
    std::__1::basic_ostream<char, std::__1::char_traits<char> >& std::__1::operator<< <std::__1::char_traits<char> >(std::__1::basic_ostream<char, std::__1::char_traits<char> >::operator<<(), 0xa);
    return;
}

function __ZNSt3__1lsINS_11char_traitsIcEEEERNS_13basic_ostreamIcT_EES6_c() {
    rax = std::__1::basic_ostream<char, std::__1::char_traits<char> >& std::__1::__put_character_sequence<char, std::__1::char_traits<char> >(arg0, &var_9, 0x1, 0x1);
    return rax;
}

function __Z1fIiEvT_() {
    std::__1::basic_ostream<char, std::__1::char_traits<char> >& std::__1::operator<< <std::__1::char_traits<char> >(std::__1::basic_ostream<char, std::__1::char_traits<char> >::operator<<(std::__1::cout, arg0), 0xa);
    return;
}

function __ZN1BclIdEEvRKT_() {
    intrinsic_movsd(xmm0, *rsi);
    std::__1::basic_ostream<char, std::__1::char_traits<char> >& std::__1::operator<< <std::__1::char_traits<char> >(std::__1::basic_ostream<char, std::__1::char_traits<char> >::operator<<(std::__1::cout), "\n");
    return;
}

function __ZN1BclIiEEvRKT_() {
    std::__1::basic_ostream<char, std::__1::char_traits<char> >& std::__1::operator<< <std::__1::char_traits<char> >(std::__1::basic_ostream<char, std::__1::char_traits<char> >::operator<<(std::__1::cout, *(int32_t *)rsi), "\n");
    return;
}
...
function imp___stubs___ZN1BclIdEEvRKT_() {
    rax = void B::operator(rdi);
    return rax;
}

function imp___stubs___ZN1BclIiEEvRKT_() {
    rax = void B::operator(rdi);
    return rax;
}
...
function imp___stubs___ZNSt3__113basic_ostreamIcNS_11char_traitsIcEEElsEb() {
    rax = std::__1::basic_ostream<char, std::__1::char_traits<char> >::operator<<();
    return rax;
}

function imp___stubs___ZNSt3__113basic_ostreamIcNS_11char_traitsIcEEElsEd() {
    rax = std::__1::basic_ostream<char, std::__1::char_traits<char> >::operator<<();
    return rax;
}
...
function imp___stubs___ZNSt3__1lsINS_11char_traitsIcEEEERNS_13basic_ostreamIcT_EES6_c() {
    rax = std::__1::basic_ostream<char, std::__1::char_traits<char> >& std::__1::operator<< <std::__1::char_traits<char> >(rdi, rsi);
    return rax;
}
