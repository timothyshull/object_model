...
struct Point_3d_single_direct : public Point_2d_single_direct {
    ...
    Point_3d_single_direct(double xx = 0.0, double yy = 0.0, double zz = 0.0) : Point_2d_single_direct{xx, yy}, z{zz} {}
...
public:
    Point_3d_single_inline(double xx = 0.0, double yy = 0.0, double zz = 0.0) : Point_2d_single_inline{xx, yy}, _z{zz} {}
...
struct Point_2d_vi1_direct : virtual public Point_1d_vi1_direct {
    ...
    Point_2d_vi1_direct() : y{0.0} {}

    Point_2d_vi1_direct(double xx, double yy) : Point_1d_vi1_direct{xx}, y{yy} {}
...
struct Point_3d_vi1_direct : public Point_2d_vi1_direct {
    ...
    Point_3d_vi1_direct(double xx = 0.0, double yy = 0.0, double zz = 0.0) : Point_2d_vi1_direct{xx, yy}, z{zz} {}
...
public:
    Point_3d_vi1_inline(double xx = 0.0, double yy = 0.0, double zz = 0.0) : Point_2d_vi1_inline{xx, yy}, _z{zz} {}
...
struct Point_2d_vi2_direct : virtual public Point_1d_vi2_direct {
    ...
    Point_2d_vi2_direct() : y{0.0} {}

    Point_2d_vi2_direct(double xx, double yy) : Point_1d_vi2_direct{xx}, y{yy} {}
...
struct Point_3d_vi2_direct : virtual public Point_2d_vi2_direct {
    ...
    Point_3d_vi2_direct(double xx = 0.0, double yy = 0.0, double zz = 0.0) : Point_2d_vi2_direct{xx, yy}, z{zz} {}
...
public:
    Point_3d_vi2_inline(double xx = 0.0, double yy = 0.0, double zz = 0.0) : Point_2d_vi2_inline{xx, yy}, _z{zz} {}
